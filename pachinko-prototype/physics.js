...
(function (root) {
  ...
  const groups = [
    ...
    [[37,297],[66,307],[50,314],[65,331]],
    [[35,342],[65,355],[44,368]],
    [[38,392],[51,413],[65,427],[59,445]],
  ...
  const stageGuide=[82,366,74,394];
  const walls=[...straightWalls,stageGuide,...segments(outerArc),...segments(canopy)];
  ...
  const api={World,STEP,WIDTH,HEIGHT,RADIUS,pins,groups,walls,rail,railPoint,railLength,stage,stageY,rightGate,launchPower,outerArc,canopy,screen,straightWalls,stageGuide,flap,flapSegment};
