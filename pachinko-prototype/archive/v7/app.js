...
function draw(){
  ...
  c.fillStyle='#6c95b7';
  c.beginPath();P.canopy.forEach(([x,y],i)=>i?c.lineTo(x,y):c.moveTo(x,y));c.closePath();
  const crown=c.createLinearGradient(0,106,0,201);crown.addColorStop(0,'#496178');crown.addColorStop(1,'#182b41');c.fillStyle=crown;c.fill();
