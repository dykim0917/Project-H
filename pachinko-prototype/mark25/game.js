(function(root){
'use strict';
const P=typeof module!=='undefined'&&module.exports?require('./physics'):root.PachinkoMark25Physics;
const BALANCE=Object.freeze({winDenominator:29,missReachRate:.10,payout:300});
...
const api={...P,World,Game,BALANCE};if(typeof module!=='undefined'&&module.exports)module.exports=api;else root.PachinkoMark25=api;
